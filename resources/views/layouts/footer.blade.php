    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="/" class="text-white/80 hover:text-secondary transition-colors">Home</a></li>
            ...
            <!-- School Hours -->
            <div>
                <h3 class="text-secondary font-semibold text-lg mb-4">School Hours</h3>
                <ul class="space-y-2">
            ...
            <!-- Contact Info -->
            <div>
                <h3 class="text-secondary font-semibold text-lg mb-4">Contact Us</h3>
                <ul class="space-y-2">
                    <li class="flex items-center">
                        <svg class="w-4 h-4 text-secondary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li class="flex items-center">
                        ...
                        <span>stfrancisofassisi.sfa@gmail.com</span>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-white/10 pt-8 mt-8">
            <div class="flex justify-center space-x-6">
                ...
                <!-- Instagram -->
                <a href="https://www.instagram.com/stfrancisofassisi/" target="_blank" rel="noopener noreferrer"
                class="text-white/80 hover:text-secondary">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- WhatsApp -->
                <a href="https://wa.me/260972266217" target="_blank" rel="noopener noreferrer"
                class="text-white/80 hover:text-secondary">
                    <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
